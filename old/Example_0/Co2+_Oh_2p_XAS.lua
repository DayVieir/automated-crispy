...
if H_atomic == 1 then
    ...
    U_3d_3d_i = 0.0
    F2_3d_3d_i = 11.6051 * 0.8
    F4_3d_3d_i = 7.2096 * 0.8
    F0_3d_3d_i = U_3d_3d_i + 2 / 63 * F2_3d_3d_i + 2 / 63 * F4_3d_3d_i

    U_3d_3d_f = 0.0
    F2_3d_3d_f = 12.3962 * 0.8
    F4_3d_3d_f = 7.708 * 0.8
    F0_3d_3d_f = U_3d_3d_f + 2 / 63 * F2_3d_3d_f + 2 / 63 * F4_3d_3d_f
    U_2p_3d_f = 0.0
    F2_2p_3d_f = 7.2598 * 0.8
    G1_2p_3d_f = 5.3941 * 0.8
    G3_2p_3d_f = 3.0679 * 0.8
...
function SaveSpectrum(G, suffix)
    ...
    Gmin1 = 0.43 - Gamma
    Gmax1 = 0.43 - Gamma
    Egamma1 = (788.1 - Eedge1) + DeltaE
    G.Broaden(0, {{Emin, Gmin1}, {Egamma1, Gmin1}, {Egamma1, Gmax1}, {Emax, Gmax1}})

    G.Print({{'file', '/home/dayane/Documents/carlos/06_23_20/Example_0/Co2+_Oh_2p_XAS_' .. suffix .. '.spec'}})
end
...
Emin = (768.1 - Eedge1) + DeltaE
Emax = (808.1 - Eedge1) + DeltaE
NE = 1000
Gamma = 0.1
DenseBorder = 2000
